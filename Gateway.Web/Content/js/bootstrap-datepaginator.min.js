    ...
    DatePaginator.prototype = {
        ...
        _buildData: function () {
            ...
            for (var m = start; m.isBefore(end); m.add('days', 1)) {
                ...
                var statusIndicator = "<br/><span class='glyphicon glyphicon-stop' style='display: none;' aria-hidden='true'></span>";
                data.items[data.items.length] = {
                    ...
                    text: (m.isSame(this.options.selectedDate)) ? m.format(this.options.textSelected) + statusIndicator : m.format(this.options.text) + statusIndicator,
        ...
        _template: {
            ...
            calendar: '<i id="dp-calendar" class="glyphicon glyphicon-th"></i>'
        },
